...
export const ORDER_PAIDED_REQUEST = "ORDER_PAIDED_REQUEST";
export const ORDER_PAIDED_SUCCESS = "ORDER_PAIDED_SUCCESS";
export const ORDER_PAIDED_FAIL = "ORDER_PAIDED_FAIL";
export const ORDER_PAIDED_RESET = "ORDER_PAIDED_RESET";
